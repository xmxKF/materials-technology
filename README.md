...
Four user-supplied AI concept films are embedded in Home, Materials, Inspection and Technical Services. The home background loops silently and respects reduced-motion preferences. Inspection, Technical Services and the 3D Lab use softly blended films with viewport autoplay, custom progress controls and persistent manual pause. Phone-sized clips, advance buffering and matching posters reduce loading. Reduced-motion and data-saving preferences require an explicit play action. The ceramic clip retains native controls. Public clips have no audio track; original source files remain private.
